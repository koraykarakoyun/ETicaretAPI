...
namespace ETicaretAPI.Persistence.Migrations
{
    ...
    [Migration("20221221183143_mig_3")]
    partial class mig_3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.File.File", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.Identity.AppUser", b =>
                {
                    ...
                    b.Property<Guid>("UserAuthRoleId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.ProductDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.Slider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.UserAuthRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.File.InvoiceFile", b =>
                {
                    b.HasBaseType("ETicaretAPI.Domain.Entities.File.File");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.File.ProductImageFile", b =>
                {
                    b.HasBaseType("ETicaretAPI.Domain.Entities.File.File");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.Identity.AppUser", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entities.UserAuthRole", "UserAuthRole")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.ProductDetail", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entities.Product", "Product")
                        ...
                        .HasForeignKey("ETicaretAPI.Domain.Entities.ProductDetail", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProductProductImageFile", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entities.File.ProductImageFile", null)
                        .WithMany()
